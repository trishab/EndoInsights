...
plt.plot(genetic_endo_counts.index, genetic_endo_counts.values, label='Genetic Mechanisms of Endometriosis', color='blue')
plt.plot(all_endo_counts.index, all_endo_counts.values, label='All Endometriosis Studies', linestyle='--', color= 'lightblue')
plt.plot(genetic_ipf_counts.index, genetic_ipf_counts.values, label='Genetic Mechanisms of IPF', color='green')
plt.plot(all_ipf_counts.index, all_ipf_counts.values, label='All IPF Studies', linestyle='--', color='lightgreen')
